...
export default function Home() {
  ...
  return (
    <main className="max-w-2xl mx-auto p-4 bg-gray-100 min-h-screen">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-6">
                  ...
                  {['A', 'B'].map((letter, i) => {
                    ...
                    return (
                      <div key={letter} className="flex justify-between items-center">
                        ...
                        <div className="text-sm mr-4 text-gray-700">3 x 8-12</div>
                        <button
            ...
            <div className="text-sm text-gray-600 mt-4">
              ...
              • Rest 1-2 minutes between supersets<br />
